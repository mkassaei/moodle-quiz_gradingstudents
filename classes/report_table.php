...
class report_table extends attempts_report_table {
     ...
     */
    public function __construct(stdClass $quiz, context_module $context, ?string $qmsubselect,
                                report_display_options $options, \core\dml\sql_join $groupstudentsjoins,
                                \core\dml\sql_join $studentsjoins, array $questions, string $reporturl) {
